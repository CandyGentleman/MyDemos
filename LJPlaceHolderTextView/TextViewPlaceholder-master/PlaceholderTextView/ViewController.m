...
@property (weak, nonatomic) IBOutlet LJPlaceholderTextView *textView;
...
- (void)viewDidLoad {
    ...
    [self.textView addMaxTextLengthWithMaxLength:0 andEvent:^(LJPlaceholderTextView *text) {
     ...
     */
    LJPlaceholderTextView *view=[[LJPlaceholderTextView alloc] initWithFrame:CGRectMake(10, 100, ScreenWidth -10*2, 80)];
    ...
    [view addMaxTextLengthWithMaxLength:100 andEvent:^(LJPlaceholderTextView *text) {
        
        NSLog(@"----------");
    }];
    
    [view addTextViewBeginEvent:^(LJPlaceholderTextView *text) {
        NSLog(@"begin");
    }];
    
    [view addTextViewEndEvent:^(LJPlaceholderTextView *text) {
        NSLog(@"end");
    }];
