...
@interface HSqqPopMenuView ()<UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate>
...
@implementation HSqqPopMenuView
...
+ (void)showWithItems:(NSArray <NSDictionary *>*)array
     ...
     triangleLocation:(CGPoint)point
               action:(void(^)(NSInteger index))action
{
    HSqqPopMenuView *view = [[HSqqPopMenuView alloc] initWithItems:array width:width triangleLocation:point action:action];
    [view show];
}
